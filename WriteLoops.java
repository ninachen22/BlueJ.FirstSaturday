...
//        w = w + 1;
    ...
    public void simpleLoops() {
        ...
        // sample while loop
        while (i <= 5) { //while i is 5 or less starting at 0, prints out "Eww."
        ...
        i = 8;
        do { //prints "Eww." from 8 to 1 while i is larger than 0
            System.out.println("Eww.");
            i = i - 1;
        } while (i > 0);
...
//        w = w + 1;
    ...
    public int manageYardAndJunior() {
        ...
        sendJuniorBackToSchool("Junior back to school 9/1");
        return w;
    }

    String voteTallies[] = {"Lincoln", "Washington", "Adams", "Lincoln", "Washington", "Adams", "Lincoln", "Washington", "Adams", "Lincoln", "Washington", "Adams", "Roosevelt"};
